...
SEARCH_QUERIES = (
    "Ausbildung Fachinformatiker Anwendungsentwicklung {city}",
    "Ausbildung Fachinformatiker Systemintegration {city}",
    "Ausbildung Informatiker {city} Kontakt",
    "IT Ausbildung {city} Impressum",
    "Ausbildungsplatz Fachinformatiker {city}"
)
...
def discover_leads(city: str, ddgs_results: int = 15) -> List[dict]:
    print(f"[SEARCH] Searching for IT leads in {city}...")
    leads = []
    seen_urls = set()
