...
SEARCH_QUERIES = [
    'IT-Unternehmen "Kontakt"',
    'Softwareentwicklungsfirmen "Karriere"',
    'IT-Dienstleister "Impressum"',
    'Systemhaus "Jobs"',
    'IT-Beratung "Kontakt"',
    'Managed Service Provider "Karriere"',
    'Cloud-Anbieter "Impressum"',
    'Cybersicherheitsfirmen "Jobs"',
    'Rechenzentrumsbetreiber "Kontakt"',
    'Softwarehersteller "Karriere"',
]
